...
// Shelly Script example: Router Watchdog that I modified to restart birdnet
//
...
let CONFIG = {
  endpoints: [
    "http://birdnetgo.local:8080",
  ],
  //number of failures that trigger the reset default is 8
  numberOfFails: 8,
  //time in seconds after which the http request is considered failed
  httpTimeout: 10,
  //time in seconds for the relay to be off was 30
  toggleTime: 10,
  //time in seconds to retry a "ping" was default is 60
  pingTime: 60,
};
